...
class ScreenAmbulanceBooking extends StatefulWidget {
  const ScreenAmbulanceBooking({Key? key}) : super(key: key);
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              title: const Text('Ambulance booking confirmed'),
                              content: SingleChildScrollView(
                                child: Column(
                                  children: [
                                    Text(
                                        'Expected arrival time : ${DateTime.now().add(const Duration(minutes: 10)).toString().substring(11, 16)}'),
                                    const Text('Ambulance number : KL14 AD2000'),
                                    const Text('Ambulance driver contact : '),
                                    TextButton.icon(
                                      onPressed: () {
